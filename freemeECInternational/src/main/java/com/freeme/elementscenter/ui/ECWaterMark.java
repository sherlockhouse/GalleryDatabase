...
public class ECWaterMark extends ECBackHandledFragment implements View.OnClickListener,
    ...
    private List<ECItemData> getItemList(String result, int type) {
        ...
        languageMap = ResultUtil.splitElementListData(result, "watermarkList");
        ...
        if (list != null) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                data.mTypeCode = ECUtil.WATERWARK_TYPE_CODE;
    ...
    private void requestDataByType(int type) {
        ...
        ECNewOnlineData dataTask = new ECNewOnlineData(type) {
            ...
            protected void onPostExecute(String result) {
                ...
                ECUtil.saveJsonStrToFile(ECUtil.WATERWARK_TYPE_ARRAY[task.getPageIndex()], result);
            }
