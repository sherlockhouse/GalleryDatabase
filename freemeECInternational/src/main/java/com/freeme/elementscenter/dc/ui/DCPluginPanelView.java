...
public class DCPluginPanelView extends LinearLayout implements PluginManager.PluginListChanged {
        ...
        PluginOnlineData dataTask = new PluginOnlineData() {
            ...
            protected void onPostExecute(List<PluginItem> result) {
                ...
                if (!TextUtils.isEmpty(jsonStr)) {
                    String fileName = ECUtil.getCurrLocaleLanguage() + "-" + "plugin"
                            + ECMainActivity.sCameraId;
    ...
    public class GridViewAdapter extends BaseAdapter implements OnClickListener {
        ...
        private void handleUninstall(View v) {
            ...
            AlertDialog.Builder b = new AlertDialog.Builder(mActivity).setTitle("插件卸载")
                    .setMessage("是否卸载此插件？");
        ...
        private void handleInstall(View v) {
            ...
            PluginItem item = (PluginItem) getItem(pos);
            Log.i("mylog","handleInstallView item:"+item+",pos:"+pos);
            if (item == null) {
                return;
            }
