...
public class ECItemDetailInfo extends DialogFragment implements View.OnClickListener,
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mPreviewW = activity.getResources().getDimensionPixelSize(R.dimen.ec_item_pageview_w);
        mPreviewH = activity.getResources().getDimensionPixelSize(R.dimen.ec_item_pageview_h);
