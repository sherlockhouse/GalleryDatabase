...
import com.android.gallery3d.gadget.LocalPhotoSource;
    ...
    private static class PhotoRVFactory implements
        ...
        public RemoteViews getViewAt(int position) {
            ...
            RemoteViews views = new RemoteViews(
                    ...
                    com.freeme.gallery.R.layout.appwidget_photo_item);
        ...
        public RemoteViews getLoadingView() {
            RemoteViews rv = new RemoteViews(
                    mApp.getAndroidContext().getPackageName(),
                    com.freeme.gallery.R.layout.appwidget_loading_item);
            rv.setProgressBar(com.freeme.gallery.R.id.appwidget_loading_item, 0, 0, true);
            return rv;
        }
