...
public class FancyLayout extends Layout {
    ...
    public void setPaddingSpec(int paddingTop, int paddingBottom) {
        ...
        Log.i(TAG, "<setPaddingSpec> <Fancy> paddingTop " + paddingTop + ", paddingBottom "
                + paddingBottom);
    }
    ...
    public boolean setSlotCount(int slotCount) {
        ...
        Log.i(TAG, "<setSlotCount> <Fancy> slotCount " + slotCount);
        return true;
    }
    ...
    public void setSize(int width, int height) {
        ...
        Log.i(TAG, "<setSize> <Fancy> getScreenWidthAtFancyMode "
...
//        }
    ...
    public void setViewHeight(int height) {
        mHeight = height;
        Log.i(TAG, "<setViewHeight> <Fancy> mHeight " + mHeight);
    }

    @Override
    public void updateSlotCount(int slotCount) {
        mSlotCount = slotCount;
        Log.i(TAG, "<updateSlotCount> <Fancy> slotCount " + slotCount);
    }
    ...
    private synchronized void updateVisibleSlotRange(int scrollPosition) {
        ...
        if (mSlotArray == null || (mSlotArray != null && mSlotArray.size() == 0)) {
            Log.i(TAG, "<updateVisibleSlotRange> <Fancy> set visible as [0, 0], mSlotArray "
                    + mSlotArray);
            setVisibleRange(0, 0);
        }
