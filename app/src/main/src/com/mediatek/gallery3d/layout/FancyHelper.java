...
//    }
    ...
    public static void doFancyInitialization(int widthPixel, int heightPixel) {
        ...
        Log.i(TAG, "<doFancyInitialization> <Fancy> w x h: " + sWidthPixels + ", "
                + sHeightPixels);
...
//                metrics.widthPixels) / FANCY_THUMBNAIL_RATIO);
    ...
    public static Bitmap decodeThumbnail(
        ...
        try {
            ...
            Log.i(TAG, "<decodeThumbnail> FileNotFoundException ", e);
            return null;
        } catch (IOException e) {
            Log.i(TAG, "<decodeThumbnail> IOException ", e);
            return null;
        } finally {
...
//        }
        ...
        Log.d(TAG, "<decodeThumbnail> decoding bmp's bounds begins at" + logTimeBeforDecode);
        ...
        Log.d(TAG, "<decodeThumbnail> decoding bmp begins at" + logTimeBeforDecode);
