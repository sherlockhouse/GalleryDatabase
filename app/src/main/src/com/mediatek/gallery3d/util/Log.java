...
//    private static final String BUILD_TYPE = SystemPropertiesProxy.get("ro.build.type");
    private static final boolean IS_ENG = true;//"eng".equalsIgnoreCase(BUILD_TYPE);
    private static final int LOG_LEVEL_IN_PROPERTY = 2;
//            SystemProperties.getInt("debug.gallery.loglevel", CUST_LOG_LEVEL_I);
    private static final int CUST_LOG_LEVEL = 2;
//            LOG_LEVEL_IN_PROPERTY >= CUST_LOG_LEVEL_V && LOG_LEVEL_IN_PROPERTY <= CUST_LOG_LEVEL_E
//                    ? LOG_LEVEL_IN_PROPERTY : CUST_LOG_LEVEL_I;

    private static final boolean FORCE_ENABLE = true;
