...
public class MtkVideoFeature {
    ...
    private static final boolean mIsGmoRamOptimize = false;
//            MTK_SUPPORT.equals(SystemProperties.get(MTK_GMO_RAM_OPTIMIZE));

    // added for slow motion
    private static final boolean supportSlowMotion = false; /*MTK_SUPPORT.equals(SystemProperties
            .get(MTK_SLOWMOTION));*/

    private static final boolean mIsSupperDimmingSupport = false;
//            MTK_SUPPORT.equals(SystemProperties.get(SUPPER_DIMMING));

    private static final boolean mIsClearMotionSupportd = false;
//            MTK_SUPPORT.equals(SystemProperties.get(MTK_CLEARMOTION));

    private static final boolean mIsOmaDrmSupported = false;
//            SystemProperties.getBoolean(MTK_OMA_DRM, false);

    // CTA Data Protection
    private static final boolean mIsSupportCTA = false;
//            MTK_SUPPORT.equals(SystemProperties.get(CTA_PROPERTY));
