...
public class AlbumSetDataLoader {
    ...
    public void pause() {
        //*/ Modified by Linguanrong for [tyd00538601] avoid exception, 2014-10-15
        if (mReloadTask != null) {
    ...
    //*/ Added by Linguanrong for story album, 2015-5-27
    public void setItemCover(int index, MediaItem cover) {
        mCoverItem[index] = cover;
    }
