...
public class WidgetLocalAlbum extends MediaSet {
    ...
    public WidgetLocalAlbum(Path path, GalleryApp application, int bucketId,
        ...
        synchronized (DataManager.LOCK) {
            ...
            if (item == null) {
                if (isImage) {
                    ...
                    /// @}
                    item = new WidgetLocalImage(path, app, cursor);
                    /// M: [DEBUG.ADD] @{
                    TraceHelper.traceEnd();
                    /// @}
                } else {
