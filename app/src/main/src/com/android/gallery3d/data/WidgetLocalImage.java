...
public class WidgetLocalImage extends LocalMediaItem {
    ...
    public WidgetLocalImage(Path path, GalleryApp application, Cursor cursor) {
    ...
    public WidgetLocalImage(Path path, GalleryApp application, int id) {
        super(path, nextVersionNumber());
        mApplication = application;
