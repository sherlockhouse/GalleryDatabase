...
public class StoryMergeAlbum extends MediaSet implements ContentListener {
    @SuppressWarnings("unused")
    private static final String TAG             = "Gallery2/StoryMergeAlbum";
    ...
    public StoryMergeAlbum(GalleryApp application, Path path, Comparator<MediaItem> comparator,
