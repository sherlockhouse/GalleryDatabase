...
/**
 * ClassName: SystemPropertiesProxy
 * Description:
 * Author: connorlin
 * Date: Created on 2016-3-17.
 */
public class SystemPropertiesProxy {
    ...
    /**
     * for system.setting.getBooleanbit
     */
    public static boolean getBooleanbit(ContentResolver cr, String name, int nick, boolean def){
        ...
        try {
            ...
            Class SystemProperties = Settings.System.class;
            ...
            Method get = SystemProperties.getMethod("getBoolbit", paramTypes);
            ...
            ret = (Boolean) get.invoke(SystemProperties, params);
