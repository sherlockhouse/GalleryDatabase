...
public class FaceAlbumSetSlidingWindow implements AlbumSetDataLoader.DataListener {
    private static final String TAG = "StorySlidingWindow";
    ...
    private final FaceAlbumLabelMaker mLabelMaker;
    ...
    public static class AlbumSetEntry extends AlbumSetSlidingWindow.AlbumSetEntry{
    ...
    public FaceAlbumSetSlidingWindow(AbstractGalleryActivity activity,
                                 AlbumSetDataLoader source, FaceAlbumSetSlotRender.LabelSpec labelSpec, int cacheSize) {
        ...
        mLabelMaker = new FaceAlbumLabelMaker(activity.getAndroidContext(), labelSpec);
