...
public class FaceSlotView extends GLView {
    ...
    private final Layout mLayout        = new FaceSlotView.Layout();
    ...
    public FaceSlotView(AbstractGalleryActivity activity, Spec spec, FaceAlbumSetSlotRender.LabelSpec labelSpec) {
    ...
    public void setSlotRenderer(SlotView.SlotRenderer slotDrawer) {
    ...
    public void setSlotSpec(Spec spec, FaceAlbumSetSlotRender.LabelSpec labelSpec) {
    ...
    public class Layout {
        ...
        private Spec mSpec;
        private FaceAlbumSetSlotRender.LabelSpec mLabelSpec;
...
//                    }
    ...
    public static class SlotEntry {
        ...
        private MediaData.MediaType mMediaType = MediaData.MediaType.INVALID;
        ...
        public SlotEntry(int index, int oritation, int imageW, int imageH, MediaItem item,
            ...
            if (imageWidth <= 0 || imageHeight <= 0) {
                ...
                if (isCameraFolder && oritation == LAND) {
                    ...
                    MediaData.MediaType mediaType = item.getMediaData().mediaType;
                    if (mediaType != MediaData.MediaType.VIDEO) {
            ...
            if (imageWidth == 0 || imageHeight == 0) {
                ...
                if (isLandCameraFolder) {
                    ...
                    scaledHeight = Utils.clamp(imageHeight * scaledWidth / imageWidth,
                            (int) (scaledWidth * FancyHelper.FANCY_CROP_RATIO_LAND),
                            (int) (scaledWidth * FancyHelper.FANCY_CROP_RATIO));
                    if (mMediaType != MediaData.MediaType.VIDEO) {
                        scaledHeight = Math.round((float) scaledWidth
                                / FancyHelper.FANCY_CROP_RATIO_CAMERA);
                    }
                } else {
    ...
    public static interface SlotRenderer extends SlotView.SlotRenderer{
    }

    public static class SimpleListener implements SlotView.Listener {
