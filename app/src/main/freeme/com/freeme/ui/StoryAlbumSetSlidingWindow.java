...
public class StoryAlbumSetSlidingWindow implements AlbumSetDataLoader.DataListener {
    ...
    public StoryAlbumSetSlidingWindow(AbstractGalleryActivity activity,
                                 AlbumSetDataLoader source, StoryAlbumSetSlotRender.LabelSpec labelSpec, int cacheSize) {
