...
import com.android.gallery3d.ui.FaceAlbumLabelMaker;
...
public class FaceAlbumSetSlotRender extends AbstractSlotRenderer {
...
//    private final ResourceTexture mLoveAlbumTarget;
    ...
    protected FaceAlbumSetSlidingWindow mDataWindow;
...
//    private final ResourceTexture[] mDefaultAlbumOverlay = new ResourceTexture[mDefaultAlbum.length];
    ...
    public FaceAlbumSetSlotRender(AbstractGalleryActivity activity,
                                SelectionManager selectionManager,
                                FaceSlotView slotView, LabelSpec labelSpec, int placeholderColor) {
        super(activity);
        mActivity = activity;
...
//        }
    ...
    public void setModel(AlbumSetDataLoader model) {
        ...
        if (model != null) {
            mDataWindow = new FaceAlbumSetSlidingWindow(
    ...
    public int renderSlot(GLCanvas canvas, int index, int pass, int width, int height) {
        ...
        //*/
        FaceAlbumSetSlidingWindow.AlbumSetEntry entry = mDataWindow.get(index);
    ...
    protected int renderOverlay(
            GLCanvas canvas, int index, FaceAlbumSetSlidingWindow.AlbumSetEntry entry, int width, int height) {
        int renderRequestFlags = 0;
        ...
        if (mPressedIndex == index) {
            if (mAnimatePressedUp) {
                ...
                renderRequestFlags |= FaceSlotView.RENDER_MORE_FRAME;
    ...
    protected int renderContent(
            GLCanvas canvas, FaceAlbumSetSlidingWindow.AlbumSetEntry entry, int width, int height) {
        int renderRequestFlags = 0;
    ...
    private class MyCacheListener implements FaceAlbumSetSlidingWindow.Listener {
...
//                mDefaultAlbumOverlay[index % mDefaultAlbum.length].draw(canvas, 0, 0, width, height);
    ...
    private void renderAddAlbumLabel(GLCanvas canvas, int height) {
        int b = FaceAlbumLabelMaker.getBorderSize();
