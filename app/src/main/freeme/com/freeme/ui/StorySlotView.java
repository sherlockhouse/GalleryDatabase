...
public class StorySlotView extends GLView {
    ...
    private final Layout mLayout        = new StorySlotView.Layout();
    ...
    public StorySlotView(AbstractGalleryActivity activity, Spec spec, StoryAlbumSetSlotRender.LabelSpec labelSpec) {
    ...
    public class Layout {
        ...
        private Spec mSpec;
        private StoryAlbumSetSlotRender.LabelSpec mLabelSpec;
