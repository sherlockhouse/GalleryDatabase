...
public class DateTileView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        mDateTextView = (TextView) findViewById(com.freeme.gallery.R.id.date_tile_day);
        mMonthTextView = (TextView) findViewById(com.freeme.gallery.R.id.date_tile_month);
        mYearTextView = (TextView) findViewById(com.freeme.gallery.R.id.date_tile_year);
    }
