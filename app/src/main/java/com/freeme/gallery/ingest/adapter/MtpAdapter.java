...
package com.freeme.gallery.ingest.adapter;
...
import com.freeme.gallery.ingest.data.SimpleDate;
import com.freeme.gallery.ingest.ui.DateTileView;
import com.freeme.gallery.ingest.ui.MtpThumbnailTileView;
...
public class MtpAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public MtpDeviceIndex.SortOrder getSortOrder() {
        return mSortOrder;
    }
