...
public class GalleryUtils {
    ...
    public static void initialize(Context context) {
        ...
        TiledScreenNail.setPlaceholderColor(r.getColor(
                com.freeme.gallery.R.color.bitmap_screennail_placeholder));
    ...
    public static boolean isCameraAvailable(Context context) {
        ...
        sCameraAvailable = pm.hasSystemFeature(PackageManager.FEATURE_CAMERA)
    ...
    public static String formatDuration(final Context context, int duration) {
        ...
        if (h == 0) {
            durationValue = String.format(context.getString(com.freeme.gallery.R.string.details_ms), m, s);
        } else {
            durationValue = String.format(context.getString(com.freeme.gallery.R.string.details_hms), h, m, s);
        }
    ...
    public static int getSelectionModePrompt(int typeBits) {
        if ((typeBits & DataManager.INCLUDE_VIDEO) != 0) {
            return (typeBits & DataManager.INCLUDE_IMAGE) == 0
                    ? com.freeme.gallery.R.string.select_video
                    : com.freeme.gallery.R.string.select_item;
        }
        return com.freeme.gallery.R.string.select_image;
    }
