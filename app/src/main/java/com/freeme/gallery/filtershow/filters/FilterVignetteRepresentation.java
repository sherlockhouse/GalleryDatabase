...
import com.freeme.gallery.filtershow.editors.EditorVignette;
import com.freeme.gallery.filtershow.imageshow.Oval;
...
public class FilterVignetteRepresentation extends FilterRepresentation implements Oval {
    ...
    public FilterVignetteRepresentation() {
        ...
        setTextId(com.freeme.gallery.R.string.vignette);
        setEditorId(EditorVignette.ID);
        setName("Vignette");
        setOverlayId(R.drawable.edit_img_yunying);
