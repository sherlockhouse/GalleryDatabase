...
import com.freeme.gallery.filtershow.imageshow.ImageCurves;

public class EditorCurves extends Editor {
    public static final int ID = com.freeme.gallery.R.id.imageCurves;
    ImageCurves mImageCurves;

    public EditorCurves() {
        super(ID);
        int k = com.freeme.gallery.R.menu.filtershow_menu_curves;
    }
