...
public class ColorOpacityView extends View implements ColorListener {
    ...
    public ColorOpacityView(Context ctx, AttributeSet attrs) {
        ...
        mCheckDim = res.getDimensionPixelSize(com.freeme.gallery.R.dimen.draw_color_check_dim);
        mDotPaint.setColor(res.getColor(com.freeme.gallery.R.color.slider_dot_color));
        mSliderColor = res.getColor(com.freeme.gallery.R.color.slider_line_color);
