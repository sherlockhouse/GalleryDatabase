...
import com.freeme.gallery.filtershow.crop.CropDrawingUtils;
import com.freeme.gallery.filtershow.crop.CropMath;
import com.freeme.gallery.filtershow.crop.CropObject;
...
public class ImageCrop extends ImageShow {
    ...
    private              GeometryMathUtils.GeometryHolder mGeometry         = new GeometryMathUtils.GeometryHolder();
    private              GeometryMathUtils.GeometryHolder mUpdateHolder     = new GeometryMathUtils.GeometryHolder();
    ...
    private void setup(Context context) {
        ...
        mCropIndicator = rsc.getDrawable(com.freeme.gallery.R.drawable.camera_crop);
        mIndicatorSize = (int) rsc.getDimension(com.freeme.gallery.R.dimen.crop_indicator_size);
        mMinSideSize = (int) rsc.getDimension(com.freeme.gallery.R.dimen.crop_min_side);
        mTouchTolerance = (int) rsc.getDimension(com.freeme.gallery.R.dimen.crop_touch_tolerance);
    }
