...
import com.freeme.gallery.filtershow.imageshow.Line;
...
public class FilterGradRepresentation extends FilterRepresentation
    ...
    public FilterGradRepresentation() {
        ...
        creatExample();
        setOverlayId(com.freeme.gallery.R.drawable.filtershow_button_grad);
        setFilterClass(ImageFilterGrad.class);
        setTextId(com.freeme.gallery.R.string.grad);
