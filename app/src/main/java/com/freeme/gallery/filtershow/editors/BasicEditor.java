...
public class BasicEditor extends ParametricEditor implements ParameterInteger {
    public static int    ID     = com.freeme.gallery.R.id.basicEditor;
    private final String LOGTAG = "BasicEditor";

    public BasicEditor() {
        super(ID, com.freeme.gallery.R.layout.filtershow_default_editor, com.freeme.gallery.R.id.basicEditor);
    }
