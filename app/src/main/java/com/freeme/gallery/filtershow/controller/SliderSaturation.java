...
import com.freeme.gallery.filtershow.colorpicker.ColorSaturationView;
...
public class SliderSaturation implements Control {
    ...
    public void setUp(ViewGroup container, Parameter parameter, Editor editor) {
        ...
        LinearLayout lp = (LinearLayout) inflater.inflate(
                com.freeme.gallery.R.layout.filtershow_saturation, container, true);

        mColorOpacityView = (ColorSaturationView) lp.findViewById(com.freeme.gallery.R.id.saturationView);
        updateUI();
