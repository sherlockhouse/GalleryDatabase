...
import com.freeme.gallery.filtershow.editors.EditorCurves;
import com.freeme.gallery.filtershow.filters.FilterCurvesRepresentation;
import com.freeme.gallery.filtershow.filters.FiltersManager;
import com.freeme.gallery.filtershow.filters.ImageFilterCurves;
...
public class ImageCurves extends ImageShow {
    ...
    public void openUtilityPanel(final LinearLayout accessoryViewList) {
        ...
        view.setText(context.getString(com.freeme.gallery.R.string.curves_channel_rgb));
    ...
    private void showPopupMenu(LinearLayout accessoryViewList) {
        final Button button = (Button) accessoryViewList.findViewById(
                com.freeme.gallery.R.id.applyEffect);
        if (button == null) {
            return;
        }
        if (mIdStrLut == null) {
            mIdStrLut = new HashMap<Integer, String>();
            mIdStrLut.put(com.freeme.gallery.R.id.curve_menu_rgb,
                    getContext().getString(com.freeme.gallery.R.string.curves_channel_rgb));
            mIdStrLut.put(com.freeme.gallery.R.id.curve_menu_red,
                    getContext().getString(com.freeme.gallery.R.string.curves_channel_red));
            mIdStrLut.put(com.freeme.gallery.R.id.curve_menu_green,
                    getContext().getString(com.freeme.gallery.R.string.curves_channel_green));
            mIdStrLut.put(com.freeme.gallery.R.id.curve_menu_blue,
                    getContext().getString(com.freeme.gallery.R.string.curves_channel_blue));
        }
        PopupMenu popupMenu = new PopupMenu(getActivity(), button);
        popupMenu.getMenuInflater().inflate(com.freeme.gallery.R.menu.filtershow_menu_curves, popupMenu.getMenu());
    ...
    public void setChannel(int itemId) {
        switch (itemId) {
            case com.freeme.gallery.R.id.curve_menu_rgb: {
                mCurrentCurveIndex = Spline.RGB;
                break;
            }
            case com.freeme.gallery.R.id.curve_menu_red: {
                mCurrentCurveIndex = Spline.RED;
                break;
            }
            case com.freeme.gallery.R.id.curve_menu_green: {
                mCurrentCurveIndex = Spline.GREEN;
                break;
            }
            case com.freeme.gallery.R.id.curve_menu_blue: {
