...
public class ColorRectView extends View implements ColorListener {
    ...
    public ColorRectView(Context ctx, AttributeSet attrs) {
        ...
        mDotPaint.setColor(ctx.getResources().getColor(com.freeme.gallery.R.color.slider_dot_color));
        mSliderColor = ctx.getResources().getColor(com.freeme.gallery.R.color.slider_line_color);
