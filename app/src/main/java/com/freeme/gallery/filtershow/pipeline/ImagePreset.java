...
import com.freeme.gallery.filtershow.filters.BaseFiltersManager;
...
import com.freeme.gallery.filtershow.filters.FilterImageBorderRepresentation;
...
import com.freeme.gallery.filtershow.filters.FilterStraightenRepresentation;
...
import com.freeme.gallery.filtershow.state.State;
...
public class ImagePreset {
    ...
    private boolean isNoneFxFilter(FilterRepresentation representation) {
        return representation instanceof FilterFxRepresentation &&
                ((FilterFxRepresentation) representation).getNameResource() == com.freeme.gallery.R.string.none;
    }
