...
public class GradControl {
    ...
    public GradControl(Context context) {
        ...
        mCenterDotSize = (int) res.getDimension(com.freeme.gallery.R.dimen.gradcontrol_dot_size);
        mMinTouchDist = (int) res.getDimension(com.freeme.gallery.R.dimen.gradcontrol_min_touch_dist);
        int grayPointCenterColor = res.getColor(com.freeme.gallery.R.color.gradcontrol_graypoint_center);
        int grayPointEdgeColor = res.getColor(com.freeme.gallery.R.color.gradcontrol_graypoint_edge);
        int pointCenterColor = res.getColor(com.freeme.gallery.R.color.gradcontrol_point_center);
        int pointEdgeColor = res.getColor(com.freeme.gallery.R.color.gradcontrol_point_edge);
        int pointShadowStartColor = res.getColor(com.freeme.gallery.R.color.gradcontrol_point_shadow_start);
        int pointShadowEndColor = res.getColor(com.freeme.gallery.R.color.gradcontrol_point_shadow_end);
        ...
        mLineColor = res.getColor(com.freeme.gallery.R.color.gradcontrol_line_color);
        mlineShadowColor = res.getColor(com.freeme.gallery.R.color.gradcontrol_line_shadow);
    }
