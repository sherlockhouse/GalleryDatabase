...
public class StyleChooser implements Control {
    ...
    //*/ Added by Linguanrong for filtershow style chooser, 2014-11-20
    ...
    public void setUp(ViewGroup container, Parameter parameter, Editor editor) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            //*/ Modified by Linguanrong for filtershow style chooser, 2014-11-20
            button.setBackgroundResource(mSelectedButton == i ?
                    R.color.style_chooser_slected_border : android.R.color.transparent);
            //*/
    ...
    private void updateSelected() {
        for (int i = 0; i < mIconButton.size(); i++) {
            mIconButton.get(i).setBackgroundResource(mSelectedButton == i ?
                    R.color.style_chooser_slected_border : android.R.color.transparent);
        }
    }
    //*/
