...
public class CategoryTrack extends LinearLayout {
    ...
    public CategoryTrack(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = getContext().obtainStyledAttributes(attrs, com.freeme.gallery.R.styleable.CategoryTrack);
        mElemSize = a.getDimensionPixelSize(com.freeme.gallery.R.styleable.CategoryTrack_iconSize, 0);
    }
