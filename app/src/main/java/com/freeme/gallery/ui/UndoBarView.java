...
public class UndoBarView extends GLView {
    ...
    public UndoBarView(Context context) {
        ...
        mPanel = new NinePatchTexture(context, com.freeme.gallery.R.drawable.panel_undo_holo);
        mUndoText = StringTexture.newInstance(context.getString(com.freeme.gallery.R.string.undo),
                GalleryUtils.dpToPixel(12), GRAY, 0, true);
        mDeletedText = StringTexture.newInstance(
                context.getString(com.freeme.gallery.R.string.deleted),
                GalleryUtils.dpToPixel(16), WHITE);
        mUndoIcon = new ResourceTexture(
                context, com.freeme.gallery.R.drawable.ic_menu_revert_holo_dark);
