...
import com.freeme.gallery.ui.BitmapScreenNail;
...
public class SinglePhotoDataAdapter extends TileImageViewAdapter
    ...
    private int mLoadingState = PhotoView.Model.LOADING_INIT;
    ...
    private void onDecodeThumbComplete(Future<Bitmap> future) {
        try {
            ...
            if (backup == null) {
                mLoadingState = PhotoView.Model.LOADING_FAIL;
                return;
            } else {
                mLoadingState = PhotoView.Model.LOADING_COMPLETE;
            }
