...
import com.freeme.gallery.data.ComboAlbum;
import com.freeme.gallery.data.DataManager;
import com.freeme.gallery.data.EmptyAlbumImage;
import com.freeme.gallery.data.FilterDeleteSet;
...
import com.freeme.gallery.data.MediaObject.PanoramaSupportCallback;
import com.freeme.gallery.data.MediaSet;
import com.freeme.gallery.data.Path;
import com.freeme.gallery.data.SecureAlbum;
import com.freeme.gallery.data.SecureSource;
import com.freeme.gallery.data.SnailAlbum;
import com.freeme.gallery.data.SnailItem;
import com.freeme.gallery.data.SnailSource;
...
import com.freeme.gallery.ui.DetailsHelper.CloseListener;
import com.freeme.gallery.ui.DetailsHelper.DetailsSource;
import com.freeme.gallery.ui.GLRootView;
import com.freeme.gallery.ui.GLView;
import com.freeme.gallery.ui.MenuExecutor;
import com.freeme.gallery.ui.PhotoView;
...
//                }
    ...
    public void refreshBottomControlsWhenReady() {
        ...
        if(canDisplayBottomControls()) {
            setBackgroundColor(new float[]{0, 248, 248, 248});
        } else {
    ...
    private void launchPhotoEditor() {
        ...
        //intent.setClassName("com.freeme.gallery", "com.freeme.gallery.filtershow.FilterShowActivity");
        //intent.setComponent(new ComponentName("com.freeme.gallery", "com.freeme.gallery.filtershow.FilterShowActivity"));
        intent.setDataAndType(current.getContentUri(), current.getMimeType())
                .setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
