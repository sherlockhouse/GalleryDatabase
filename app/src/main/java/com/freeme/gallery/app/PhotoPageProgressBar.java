...
public class PhotoPageProgressBar {
    ...
    public PhotoPageProgressBar(Context context, RelativeLayout parentLayout) {
        ...
        mContainer = (ViewGroup) inflater.inflate(com.freeme.gallery.R.layout.photopage_progress_bar, parentLayout,
                false);
        parentLayout.addView(mContainer);
        mProgress = mContainer.findViewById(com.freeme.gallery.R.id.photopage_progress_foreground);
    }
