...
import com.freeme.gallery.ui.CacheStorageUsageInfo;
import com.freeme.gallery.ui.GLRoot;
import com.freeme.gallery.ui.GLView;
import com.freeme.gallery.ui.ManageCacheDrawer;
...
public class ManageCachePage extends ActivityState implements
    ...
    private GLView mRootPane = new GLView() {
        ...
        protected void onLayout(
            ...
            View footer = mActivity.findViewById(com.freeme.gallery.R.id.footer);
            if (footer != null) {
                int location[] = {0, 0};
    ...
    public void onConfigurationChanged(Configuration config) {
        ...
        FrameLayout layout = (FrameLayout) mActivity.findViewById(com.freeme.gallery.R.id.footer);
    ...
    protected int getBackgroundColorId() {
        return com.freeme.gallery.R.color.cache_background;
    }
    ...
    private void refreshCacheStorageInfo() {
        ProgressBar progressBar = (ProgressBar) mFooterContent.findViewById(com.freeme.gallery.R.id.progress);
        TextView status = (TextView) mFooterContent.findViewById(com.freeme.gallery.R.id.status);
        ...
        if (totalBytes == 0) {
            ...
            String label = activity.getString(com.freeme.gallery.R.string.free_space_format, "-");
    ...
    private void initializeFooterViews() {
        ...
        mFooterContent = inflater.inflate(com.freeme.gallery.R.layout.manage_offline_bar, null);

        mFooterContent.findViewById(com.freeme.gallery.R.id.done).setOnClickListener(this);
        refreshCacheStorageInfo();
    }
    ...
    private void showToastForLocalAlbum() {
        ...
        Toast.makeText(activity, activity.getResources().getString(
                com.freeme.gallery.R.string.try_to_set_local_album_available_offline),
                Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onClick(View view) {
        Utils.assertTrue(view.getId() == com.freeme.gallery.R.id.done);
        ...
        try {
            ...
            menuExecutor.startAction(com.freeme.gallery.R.id.action_toggle_full_caching,
                    com.freeme.gallery.R.string.process_caching_requests, this);
        } finally {
    ...
    private void showToast() {
        if (mAlbumCountToMakeAvailableOffline > 0) {
            ...
            Toast.makeText(activity, activity.getResources().getQuantityString(
                    com.freeme.gallery.R.plurals.make_albums_available_offline,
                    mAlbumCountToMakeAvailableOffline),
                    Toast.LENGTH_SHORT).show();
        }
    }
