...
public class DecodeUtils {
    ...
    public static Bitmap decodeThumbnail(
        ...
        try {
            ...
            com.freeme.gallery.ui.Log.w(TAG, ex);
            return null;
        } finally {
    ...
    public static BitmapRegionDecoder createBitmapRegionDecoder(
        ...
        try {
            ...
            com.freeme.gallery.ui.Log.w(TAG, t);
            return null;
        }
    }
    ...
    public static BitmapRegionDecoder createBitmapRegionDecoder(
        ...
        try {
            ...
            com.freeme.gallery.ui.Log.w(TAG, "requestCreateBitmapRegionDecoder: " + t);
            return null;
        }
    }
    ...
    public static Bitmap decodeUsingPool(ThreadPool.JobContext jc, byte[] data, int offset,
        ...
        try {
            ...
            com.freeme.gallery.ui.Log.w(TAG, "decode fail with a given bitmap, try decode to a new bitmap");
            GalleryBitmapPool.getInstance().put(options.inBitmap);
            options.inBitmap = null;
    ...
    private static Bitmap findCachedBitmap(ThreadPool.JobContext jc, FileDescriptor fileDescriptor,
                                           Options options) {
