...
public abstract class MultiSelectGridFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.freeme.gallery.R.layout.multigrid_content, container, false);
    }
    ...
    private void ensureGrid() {
        ...
        if (root instanceof GridView) {
            ...
            mProgressContainer = root.findViewById(com.freeme.gallery.R.id.progressContainer);
            mGridContainer = root.findViewById(com.freeme.gallery.R.id.gridContainer);
