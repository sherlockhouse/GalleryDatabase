...
import com.freeme.photos.drawables.DataUriThumbnailDrawable;
...
public class PhotoSetLoader extends CursorLoader implements LoaderCompatShim<Cursor> {
    ...
    private static final Uri             GLOBAL_CONTENT_URI = Uri.parse("content://" + GalleryStore.AUTHORITY + "/external/");
