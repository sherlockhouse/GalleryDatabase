...
package com.freeme.photos.adapters;
...
import com.freeme.photos.data.PhotoSetLoader;
import com.freeme.photos.shims.LoaderCompatShim;
import com.freeme.photos.views.GalleryThumbnailView;
...
public class PhotoThumbnailAdapter extends CursorAdapter implements GalleryThumbnailView.GalleryThumbnailAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        View view = mInflater.inflate(com.freeme.gallery.R.layout.photo_set_item, parent, false);
        return view;
    }

    @Override
    public void bindView(View view, Context context, Cursor cursor) {
        ImageView iv = (ImageView) view.findViewById(com.freeme.gallery.R.id.thumbnail);
