...
//    public static final boolean SUPPORT_CTA = SystemProperties.get(CTA_PROPERTY).equals("1");
    ...
    public static final boolean SUPPORT_SLOW_MOTION = false; /*SystemProperties.get(
...
//            .equals("tablet");
    ...
    public static final boolean IS_GMO_RAM_OPTIMIZE = true;
//            SystemProperties.get(MTK_GMO_RAM_OPTIMIZE).equals("1");
...
//        }
    ...
    static {
        ...
        Log.i(TAG, "CPU_CORES_NUM = " + CPU_CORES_NUM);
        Log.i(TAG, "sSupportRefocus = " + sSupportRefocus);
        Log.i(TAG, "SUPPORT_HEAVY_FEATURE = " + SUPPORT_HEAVY_FEATURE);
        Log.i(TAG, "SUPPORT_FANCY_HOMEPAGE = " + SUPPORT_FANCY_HOMEPAGE);
//        Log.i(TAG, "SUPPORT_MTK_BEAM_PLUS = " + SUPPORT_MTK_BEAM_PLUS);
//        Log.i(TAG, "SUPPORT_DRM = " + SUPPORT_DRM);
//        Log.i(TAG, "SUPPORT_CTA = " + SUPPORT_CTA);
//        Log.i(TAG, "SUPPORT_HEVC = " + SUPPORT_HEVC);
//        Log.i(TAG, "SUPPORT_SLOW_MOTION = " + SUPPORT_SLOW_MOTION);
//        Log.i(TAG, "SUPPORT_2K_VIDEO = " + SUPPORT_2K_VIDEO);
//        Log.i(TAG, "SUPPORT_EMULATOR = " + SUPPORT_EMULATOR);
//        Log.i(TAG, "SUPPORT_PQ = " + SUPPORT_PQ);
//        Log.i(TAG, "IS_GMO_RAM_OPTIMIZE = " + IS_GMO_RAM_OPTIMIZE);
        Log.i(TAG, "sIsLowRamDevice = " + sIsLowRamDevice);
    }
}
